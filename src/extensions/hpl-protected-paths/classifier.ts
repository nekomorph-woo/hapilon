...
const resolveTargetSync = (targetPath: string, cwd: string): string => {
...
export const resolveTargetEffect = (targetPath: string, cwd: string): Effect.Effect<string, never> =>
  Effect.sync(() => resolveTargetSync(targetPath, cwd));
