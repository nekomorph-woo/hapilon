...
```bash
python3 .claude/skills/changelog-alpha/scripts/run.py >> _CHANGELOG-alpha.md
```
...
- [ ] 运行 `python3 .claude/skills/changelog-alpha/scripts/run.py >> _CHANGELOG-alpha.md`
