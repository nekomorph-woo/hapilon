...
import { agentStateWithSeq } from "./herdr.js";
 ...
 */
export function waitForPaneSettle(paneId, options = {}, deps = defaultWaitDeps) {
 ...
 */
export function runWaitPaneCommand(args, deps = defaultWaitDeps) {
    ...
    console.log(`[wait-pane] ${paneId} → ${result.outcome}（status=${result.status}，`
