...
function parseRoleDef(path, value) {
    ...
    if (typeof selectedTier !== "string" || !TIERS.has(selectedTier)) {
...
export function loadCustomRoleDefs() {
...
export function saveCustomRoleDef(role) {
    ...
    if (!parsed || getRoleDef(parsed.key)?.builtin)
        return false;
    try {
        const directory = rolesDir();
...
export function deleteCustomRoleDef(key) {
