...
import { buildTeamSections, currentRole, isTeamOwner, readTeamState, resolveSessionStatePath, writeTeamStateEffect, } from "../../extensions/hpl-orchestra/state.js";
...
describe("hpl-orchestra pane actions", { concurrency: false }, () => {
    ...
    it("reviewer 懒创建使用 opus 档", async () => {
        ...
        assert.deepEqual(updated.roles.reviewer, { paneId: "w1:p9", model: "anthropic/claude-opus" });
    });
