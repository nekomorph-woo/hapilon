...
import { isExpandable, collectExpandables, patternMatches, titleOfLines, panelTitle, findNewestPanel, decorateExpandable, } from "../../extensions/hpl-panel-viewer/panels.js";
import { panelMarker } from "../../extensions/hpl-panel-viewer/shared.js";
import { applyPopConfig } from "../../extensions/hpl-panel-viewer/config.js";
...
describe("decorateExpandable marker", () => {
    ...
    function makePanel(expanded, n = 2) {
        const comp = {
            toolName: "bash",
            expanded,
