...
import { collectContextSnapshot, } from "../../extensions/hpl-context-viewer/collector.js";
import { clearLastMeta, setLastMeta, } from "../../extensions/hpl-system-prompt/metadata.js";
...
describe("token 统计不重复计算（issue #8）", () => {
    ...
    it("spTokens 只含纯 system 部分，不含 tools/skills/contextFiles/rules", () => {
        ...
        // roleAndIdentity 100 + piDocumentation 100 + guidelines 100 + codeStyle 250 + commitDiscipline 40 + environment 100 = 690 chars → 173 tokens
        assert.equal(spCat.tokens, 173);
    });
