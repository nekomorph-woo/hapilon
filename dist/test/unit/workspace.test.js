...
import { buildWorkspacePaneContent, formatAddedDirTime, readAddedWorkspaceDirs, } from "../../extensions/hpl-startup-header/workspace.js";
import { createStartupHeader, shortenWorkspacePath, } from "../../extensions/hpl-startup-header/content.js";
...
describe("hpl-startup-header workspace", () => {
    it("按 home/非 home 规则压缩路径", () => {
        ...
        assert.equal(shortenWorkspacePath("/Users/alice/morphiiouo/work/hapilon/deep", "/Users/alice"), "~/morphiiouo/…/hapilon/deep");
        assert.equal(shortenWorkspacePath("/Volumes/Under_M2/morphiiouo/hapilon", "/Users/alice"), "/Volumes/Under_M2/…/hapilon");
    });
