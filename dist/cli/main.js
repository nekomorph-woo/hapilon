...
export async function main() {
    ...
    const { hasFlag, readHapilonConfig, writeHapilonConfig, injectDefaultArgs, stripHapilonFlags } = await import("../config/config-io.js");
    const isNonInteractive = hasFlag(args, "-p") || hasFlag(args, "--print") || hasFlag(args, "--mode");
    const noSafety = hasFlag(args, "--no-safety");
    const piCli = resolvePiCli();
    const { agentDir } = await import("../config/hapilon-home.js");
    ...
    const { ensureQuietStartup } = await import("../providers/providers.js");
    ...
    const safetySettings = await import("../safety/safety-settings.js");
    if (noSafety) {
    ...
    const { ensureExtensionConfigs } = await import("../extensions/ensure-configs.js");
    ...
    const { resolveNpmExtensionPaths } = await import("../extensions/npm-extensions.js");
    ...
    const { extensionNames: namesOf } = await import("../extensions/loader.js");
